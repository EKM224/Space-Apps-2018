function generateIndividualPage(launchInfo) {
    ...
    document.getElementById('company-name').innerHTML = launchInfo.company;
    document.getElementById('vehicle').innerHTML = launchInfo.vehicle;
    document.getElementById('customer').innerHTML = launchInfo.customer;
    document.getElementById('individual-date').innerHTML = launchInfo.date;
    document.getElementById('individual-description').innerHTML = launchInfo.description;
